...
auto createContext(const Tour::Activity& prev, const Tour::Activity& next) {
  ...
  return std::pair<std::shared_ptr<InsertionRouteContext>,
                   std::shared_ptr<ServiceInsertionEvaluator>>{routeCtx, evaluator};
}
