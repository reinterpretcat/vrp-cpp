...
public:
  ...
  __host__ __device__ explicit aggregate_output_iterator(OutputIterator const& out,
                                                         UnaryFunction fun) :
    super_t(out),
    fun(fun) {}
...
template<typename UnaryFunction, typename OutputIterator>
aggregate_output_iterator<UnaryFunction, OutputIterator> __host__ __device__
